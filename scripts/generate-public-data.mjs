...
for (const fund of registry.funds) {
  ...
  const record = { projection_schema:'ETFCTA-PUBLIC-EXPORT-001-v0.1.0', release: registry.release, generated_from: '../registry.json', fund, sources: registry.sources.filter((s) => sourceIds.has(s.source_id)).map(publicSource), evidence, decisions };
