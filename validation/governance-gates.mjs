...
export function releaseGovernanceGate({contract,releaseGate,routeManifest,changelog,decisionLog,releaseArchive,attestation,artifactHashes,integrityManifestHash,subjectCommitSha}) {
