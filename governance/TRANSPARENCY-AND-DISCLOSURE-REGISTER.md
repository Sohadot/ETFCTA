# Transparency and Disclosure Register

Last reviewed: 18 July 2026

| Item | Current disclosure |
|---|---|
| Operator | Independent ETFCTA project; named legal/operator identity not yet published |
| Current public registry release | v0.1.0 founding empty registry |
...
| Declared conflicts | None recorded |
| Material corrections | None recorded |
| Data interruptions | None recorded |
| Automated decision-making | None; fixture automation tests validation only |
